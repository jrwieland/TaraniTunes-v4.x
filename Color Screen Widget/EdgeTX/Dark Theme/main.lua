...
-- Cell Voltage
  ...
  lcd.drawChannel(380, 130,"LCEL", DBLSIZE+PREC2+ORANGE) --displays a custom telementry sensor (lowest cell)calculated from "cels" sensor
